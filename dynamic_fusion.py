...
parser.add_argument('--testpath', default='', help='testing data path')
parser.add_argument('--tntpath', default='', help='tnt data path')
parser.add_argument('--testlist', default='lists/tnt/intermediate.txt', help='testing scan list')
parser.add_argument('--outdir', default='', help='output dir')
parser.add_argument('--photo_threshold', type=float, default=0.5, help='photo threshold for filter confidence')
parser.add_argument('--display', action='store_true', help='display depth images and masks')
parser.add_argument('--test_dataset', default='tnt', choices=['dtu','tnt'], help='which dataset to evaluate')
